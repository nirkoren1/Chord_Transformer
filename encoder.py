...
class Encoder(keras.layers.Layer, ABC):
    ...
    def feed_forward(self, input_, padding_mask, training):
        result = input_
        for i in range(self.N):
            result = self.multi_heads[i].feed_forward(result, result, result, padding_mask, training)
